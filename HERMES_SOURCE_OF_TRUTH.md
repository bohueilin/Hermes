...
- **Map motion, phases 1 and 2 (added 2026-09-15).** A survey of the built page found the map nearly still: over 600
  ...
  end overhangs a yard on 8.33% and 11.95%, where its hues measure 3.90 and 2.82 and its surface ring 1.13:1. Phases 3
  (bay cells inside the depot tile) and 4 (a day-long bar under the scrubber) are approved but not built.
