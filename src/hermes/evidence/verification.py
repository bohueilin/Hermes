...
def _profile_errors(
    ...
    if context.adapter.name == "fake":
        ...
        expected_metadrive_config = {
            ...
            # Mirrors producer configuration through metadrive_map_for_gap. Sharing is
            # sound: verification never imports runtime adapters, and simulator_support is
            # the sanctioned import-safe home both sides already use. The reviewed pinned
