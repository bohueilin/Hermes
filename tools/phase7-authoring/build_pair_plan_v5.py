...
ledger_bytes = (WORK / "lead_ttc_engagement.discovery.v5.jsonl").read_bytes()
...
pair = {
    "schema_version": "2.0",
    "pair_plan_id": "lead_ttc_engagement_pair_v5",
    ...
    "selected_scenario_relative_path": (
        "scenarios/metadrive_lead_vehicle_hard_brake_adequacy_v2.yaml"
    ),
}
...
(WORK / "lead_ttc_engagement.pair.v5.yaml").write_text(pair_yaml, encoding="utf-8")
