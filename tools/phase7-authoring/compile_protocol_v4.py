...
BODY = {
    ...
    "registration": {
        "repository_relative_path": "evaluation-plans/lead_ttc_engagement.protocol.v4.yaml"
    },
}
...
(out / "lead_ttc_engagement.protocol.v4.yaml").write_bytes(result.protocol_yaml_bytes)
