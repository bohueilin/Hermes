...
PROTOCOL_PATH = ROOT / "evaluation-plans" / "lead_ttc_engagement.protocol.v1.yaml"
...
for variant in protocol.materializer.variants:
    ...
    run_id = f"p7-discovery-{index:04d}"
...
(WORK / "lead_ttc_engagement.discovery.v1.jsonl").write_bytes(ledger_bytes)
