...
PROTOCOL_PATH = ROOT / "evaluation-plans" / "lead_ttc_engagement.protocol.v3.yaml"
...
for variant in protocol.materializer.variants:
    ...
    run_id = f"p7-v3-discovery-{index:04d}"
...
(WORK / "lead_ttc_engagement.discovery.v3.jsonl").write_bytes(ledger_bytes)
